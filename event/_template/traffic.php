        ...
        <div class="col-md-12">
            <div class="widget widget_trafic"> 
                <ul>
                    <li class="h4">公車</li>
                    <ul>
                        <li>請搭臺北市公車 205、212 (直行/區間)、270、276、306、620、645 任何一班至中研院站 (前一站為中研新村站) 。</li>
                    </ul>
                    <br/>
                    <li class="h4">捷運</li>
                    <ul>
                        <li>請搭捷運板南線至南港站二號出口換乘公車 212 (直行/區間)、270 或藍 25 至中研院站。</li>
                        <li>搭捷運文湖線至南港展覽館站 (5號出口) ，走至南港國小對面換乘公車 205、276、306 或 645 至中研院站。</li>
                    </ul>
                    <br/>
                    <li class="h4">火車</li>
                    <ul>
                        <li>請搭火車至南港火車站換乘公車 212、270 或藍 25 至中研院站。</li>
                    </ul>
                    <br/>
                    <li class="h4">自行開車</li>
                    <ul>
                        <li>請參考下方 Google 地圖開車至中央研究院院區 (臺北市研究院路二段 128 號)。</li>
                        <li>開車請由正門進入院區。</li>
