...
$caption = array( '資料科學的第一堂課：', '<span style="font-size:0.8em;">心法、案例分析與團隊建立</span>' );

$event_date = strtotime('2016-01-30 00:00:00');
$weekdays = array( '0'=>'日', '1'=>'一', '2'=>'二', '3'=>'三', '4'=>'四', '5'=>'五', '6'=>'六' );
$date_string = date('Y/n/j',$event_date) . ' (' . $weekdays[date('w',$event_date)] . ')';

$kktix_link = 'data-team-jan2016-plus';
$kktix_date = strtotime('2015-12-31 12:00:00');
$reg_date = strtotime('2016-01-13 12:00:00');
$reg_time = '中午 12:00';
$deadline = strtotime('2016-01-18 12:00:00');
$price = 1980;
