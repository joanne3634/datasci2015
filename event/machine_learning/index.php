...
$speakers = array(
        ...
        'engn' => '(Hsuan-Tien Lin)',
        'title' => array(
            '<a href="https://www.csie.ntu.edu.tw/people/bio.php?PID=77" target="_blank">台灣大學資訊工程系 副教授</a>'
        ),
        'info' => array(
            '林軒田在美國加州理工學院取得博士學位，現於台灣大學資訊工程系任教，並在沛星科技兼任技術顧問。林教授的研究方向為「機器學習的理論基礎與演算法設計」，他合著了在亞馬遜線上書店暢銷的機器學習入門教科書「Learning From Data」，並依此書在 Coursera 平台上開設了「機器學習基石」與「機器學習技法」兩門熱門的大型公開線上課程。林教授曾獲得 2011 年台灣大學「教學傑出教師獎」，2013 年台灣大學「優良導師獎」，2012 年 ACM Taipei Chapter「李國鼎青年研究獎」與 2013 年國科會「吳大猷先生紀念獎」。林教授另共同帶領了台灣大學的團隊，在 2010 至 2013 年，連續獲得了四年 (六座) 的 KDDCup 世界冠軍。'
        )
    )
