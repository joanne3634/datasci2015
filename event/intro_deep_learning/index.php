...
$speakers = array(
    'sckang' => array(
        ...
        'title' => array(
            '<a href="http://sckang.caece.net/" target="_blank">台大土木系教授兼副教務長</a>'
        ),
        'info' => array(
            '康仕仲教授是台大土木系教授兼副教務長、美國史丹福大學博士。康教授長期投入於工程視覺化、自動化機器人、工程教育以及防災資訊系統之研發。在台大開設電腦繪圖、遊戲引擎、資料視覺化及機器人等課程，曾獲得優良教師獎。康教授曾擔任教學發展中心數位媒體組組長，負責開放式課程及數位化教育的推廣，他在 Coursera 上開設的工程圖學系列課程，共有超過 5 萬人修習。現擔任國際期刊 Visualization in Engineering 總編輯，編輯十餘本工程視覺化及機器人自動化主題之特刊和專書，發表超過 50 篇的期刊論文。欲瞭解康博士的研究及心得分享，請至他的<a href="http://sckang.caece.net/" target="_blank">個人網頁</a>一探究竟。'
        )
    )
);
