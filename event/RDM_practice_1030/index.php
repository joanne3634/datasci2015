...
$about = array(
    ...
    '這門六小時的課程，將從最實務的角度切入，與大家分享如何將現實中亟待解決的問題，轉換成可以利用資料探勘技術處理的問題，並且運用 R 語言中各種強大的工具，進行關聯性分析、迴歸分析以及叢聚分析，以達成將資料中隱藏的資訊挖掘出來的最終目標。',
    '本課程由四個部分組成：
        <ol>
        <li>
            資料探勘基石<br>
...
$speakers = array(
    'helen' => array(
        ...
        'info' => array(
            '許懷中博士 2011 年於國立交通大學資訊科學與工程學系取得博士學位，現為逢甲大學資訊工程學系助理教授，許博士通曉資料科學相關之基礎理論並具備豐富的實務經驗，過去數年間，許博士與陳昇瑋博士所領導之資料科學團隊合作為遊戲產業、線上教育以及職業運動產業，進行多項資料科學專案，以其在資料科學領域獨特的知能與熱情，為台灣產業尋找埋藏於海量資料中的價值；此外，為了培養國內資料科學人才，許博士曾在資策會、外貿協會、宏達電以及台灣資料科學年會等場合講授以 R 語言進行資料工程與探勘的相關實務技術，其充滿熱情、以簡御繁的教學方式，頗受上課學員之好評。',
        ),
    ),    
);
$team = array(
