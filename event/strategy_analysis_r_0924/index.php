...
$kktix_link = 'strategy_analysis_r_0924';
...
$speakers = array(
    'helen' => array(
        ...
        'info' => array(
            '吳牧恩教授為數理背景出身、資工博士畢業，其研究領域包括資訊理論與金融資料分析。現為東吳大學數學系助理教授，致力於推廣資金管理的數學與使用R語言研發金融交易策略，期望破除市場上大眾追求穩賺聖盃的迷思。其亦為知名財金部落格幣圖誌 (Bituzi) 專欄作家 -- 牧清華。',
        ),
    ),    
    'blabla' => array(
        'detail' => true,
        ...
        'info' => array(
            '林佳緯先生為資訊背景出身，但轉個彎拿的是財務金融學歷，興趣為計算金融相關研究。曾任職於四大事務所企管顧問管理公司，負責上市櫃公司財務績效管理系統導入諮詢服務。現為新創公司Fintech團隊系統顧問與獨立交易人，自行開發交易系統與計量交易策略。',
        ),
    ),
