...
$speakers = array(
    ...
    'sean' => array(
        ...
        'info' => array(
            '台大心理所畢，現為中研院資訊科學所研究助理，目前主要負責消費數據及知名 APP 的資料前處理、探索性資料分析及統計分析。','從國中開始就以玩外掛和打破遊戲設定為樂，為了讓時間運用的更有效率 ( 偷懶? ) 和讓外掛更 "人性化" 而開始學習程式語言。大學及研究所期間在行為科學與大腦的灰色世界裡遊走，擅長實驗設計與統計分析以及功能性磁振造影分析與建模。在發現現實世界滿出來的資料就是最大的實驗室及遊樂場後，一腳踩進這巨大的社會實驗室裡，期盼某天能透過龐大的社會實驗與資料找到讓社會更美好的方法。'
        )
    )
);
$team = array(
